...
function snapshotBlock(part,index,p){
  ...
  return {
    ...
    description:part.instruction||'',color:intensityColor(p,part),intensityHeightPercent:intensityHeight(p,part),targets
  };
}
